...
module.exports = class PurgeCommand extends Command {
  constructor(context, options) {
    super(context, {
      ...options,
      name: 'purge',
      aliases: ['purge', 'prune', 'delete', 'clear', 'clean', 'del', 'd'],
    ...
    (async (delay) => {
      ...
      while (del) {
        ...
        if (leftToDelete > 100) {
          ...
          let deletedAmount = await message.channel.bulkDelete(fetch).catch((err) => { console.log(err) });
